...
//  Account Service object
    ...
    @DELETE
    @Path ("/{accountID}/deleteMovie/{movieID}")
    public String deleteMovie(@PathParam("movieID")long movieID,@PathParam("accountID") long accountID){
        return accountService.deleteMovie(movieID,accountID);
    }
}
